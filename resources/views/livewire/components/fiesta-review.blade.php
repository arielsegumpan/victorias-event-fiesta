    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div class="relative z-10 p-4 mt-5 bg-white border rounded-xl sm:mt-10 md:p-10 dark:bg-neutral-900 dark:border-neutral-700">
        ...
        <form wire:submit.prevent="submitReview"
            ...
            <!-- Submit -->
            <button wire:loading.attr="disabled" type="submit" class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 rounded-lg">
