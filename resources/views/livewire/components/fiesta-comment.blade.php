        ...
        <form wire:submit.prevent="submitComment"
            ...
            <div>
                ...
                <textarea wire:model.blur="comment"
                        rows="3"
                        class="block w-full px-4 py-3 text-sm border-1 border-gray-200 rounded-lg focus:border-orange-500 focus:ring-orange-500 dark:bg-neutral-900 dark:border-neutral-400 dark:text-neutral-400"
            ...
            >
                ...
                <!-- Dropzone -->
                <div
                    class="w-full p-6 border-2 border-dashed rounded-lg text-center cursor-pointer bg-white hover:bg-orange-50 transition dark:bg-neutral-800"
