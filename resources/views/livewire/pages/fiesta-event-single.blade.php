                ...
                <div class="py-8 lg:pe-8">
                    <div class="space-y-5 lg:space-y-8">
                        ...
                        <div class="flex flex-row gap-x-4">
                            <span
                                class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-green-100 text-green-800 dark:bg-green-800/30 dark:text-green-500">
                                <svg class="shrink-0 size-4 text-green-800 dark:text-green-500"
                            ...
                            <span
                                class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-red-100 text-red-800 dark:bg-red-800/30 dark:text-red-500">
                                <svg class="shrink-0 size-4 text-red-800 dark:text-red-500"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                    <rect width="256" height="256" fill="none" />
                                    <rect x="40" y="40" width="176" height="176" rx="8" fill="none"
                                        stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="flex justify-end items-center gap-x-1.5">
                                ...
                                <div class="flex flex-row">
                                    <a class="flex items-center py-2 px-2 rounded-lg text-sm text-gray-700 hover:bg-amber-50 dark:text-neutral-300 dark:hover:bg-neutral-800 transition"
                                        href="https://www.twitter.com/intent/tweet?url={{ urlencode(route('fiesta-eventos-single.page', $this->fiesta->f_slug)) }}&amp;text={{ urlencode($this->fiesta->f_name) }}"
                                        target="_blank" title="Share on Twitter">
                                        <svg class="w-4 h-4 text-sky-500" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a class="flex items-center py-2 px-2 rounded-lg text-sm text-gray-700 hover:bg-amber-50 dark:text-neutral-300 dark:hover:bg-neutral-800 transition"
                                        href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('fiesta-eventos-single.page', $this->fiesta->f_slug)) }}"
                                    ...
                                    <a class="flex items-center py-2 px-2 rounded-lg text-sm text-gray-700 hover:bg-amber-50 dark:text-neutral-300 dark:hover:bg-neutral-800 transition"
                                        href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('fiesta-eventos-single.page', $this->fiesta->f_slug)) }}"
                                        target="_blank" title="Share on LinkedIn">
                                        <svg class="w-4 h-4 text-blue-700" xmlns="http://www.w3.org/2000/svg"
                                            fill="currentColor" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <a class="flex items-center py-2 px-2 rounded-lg text-sm text-gray-700 hover:bg-amber-50 dark:text-neutral-300 dark:hover:bg-neutral-800 transition"
                                        href="mailto:?subject={{ $this->fiesta->f_name }}&amp;body={{ $this->fiesta->f_description }}"
                        ...
                        <div class="lg:mt-8 ">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="text-gray-600 dark:text-neutral-200">
                                    <p class="mb-2"> {!! Str::limit($this->fiesta->barangay->brgy_desc, 300, '...') !!}
                                    </p>
                                </div>
                            </div>
                        </div>
