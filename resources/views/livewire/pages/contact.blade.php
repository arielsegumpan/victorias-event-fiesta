<div>
    ...
    <div class="grid items-center gap-4 mt-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        <!-- Icon Block -->
        <a class="flex flex-col h-full p-4 text-center rounded-md group hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 sm:p-6 dark:hover:bg-neutral-500/10 dark:focus:bg-neutral-500/10" href="#">
