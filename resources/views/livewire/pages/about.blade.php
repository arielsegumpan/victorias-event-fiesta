        ...
        <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
                ...
                <div>
                    <!-- Heading -->
                    <div class="mb-4">
                        <h3 class="text-orange-500 text-xs font-medium uppercase">
                            Steps
                        </h3>
                    </div>
                    <!-- End Heading -->
                    ...
                    <div class="flex gap-x-5 ms-1">
                        ...
                        <div
                            ...
                            <div class="relative z-10 size-8 flex justify-center items-center">
                                <span
                                    class="flex shrink-0 justify-center items-center size-8 border border-neutral-800 text-orange-500 font-semibold text-xs uppercase rounded-full">
                                    1
                                </span>
                            </div>
                        </div>
                    ...
                    <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-orange-500 font-medium text-sm text-neutral-800 rounded-full focus:outline-hidden"
                        href="#">
